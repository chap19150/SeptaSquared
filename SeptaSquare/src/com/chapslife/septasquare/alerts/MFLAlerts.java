...
public class MFLAlerts extends HttpServlet {

	private static final Logger log = Logger.getLogger(MFLAlerts.class.getName());
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		String advisory = "";
		try {
			URL url = new URL("http://www3.septa.org/hackathon/Alerts/get_alert_data.php?req1=rr_route_mfl");
